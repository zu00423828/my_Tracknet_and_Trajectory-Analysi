...
checkpoint = ModelCheckpoint(save_weights_path + ".0", monitor='loss', verbose=1, save_weights_only=True,mode='min')
callbacks_list = [checkpoint]

m.fit_generator( Generator, step_per_epochs, epochs,callbacks=callbacks_list,verbose=2)
m.save_weights( save_weights_path + ".10" )
...
for ep in range(1, epochs+1 ):
	...
	m.fit_generator(Generator, step_per_epochs,verbose=2)
